...
class EmployeePositionByOrganizationResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        $personalSubArea = [];
        if($organization){
            $personalArea = $organization->masterPersonalArea;
            $personalSubArea = $organization->masterPersonalSubArea;
        }
        ...
        return [
            ...
            'personal_area_id'=> ($personalArea) ? $personalArea->id : null,
            'personal_area'=> ($personalArea) ? $personalArea->description : null,
            'personal_sub_area'=> ($personalSubArea) ? $personalSubArea->description : null,
