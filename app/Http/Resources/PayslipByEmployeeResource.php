...
class PayslipByEmployeeResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        $empPos = EmployeePosition::where('employee_id',$this->id)->where('active','1')->first();
        ...
        return [
            ...
            'unit_kerja' => ($empPos) ? $empPos->unit_kerja : null,
            'company' => ($empPos) ? $empPos->company->name : null,
