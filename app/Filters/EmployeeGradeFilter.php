...
class EmployeeGradeFilter extends QueryFilters
{
    protected $request;
    ...
    public function grade($term) {
        return $this->builder->where('grade',$term);
    }

    public function sub_grade($term) {
        return $this->builder->where('sub_grade',$term);
    }
